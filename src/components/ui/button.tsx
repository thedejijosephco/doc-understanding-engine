  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background text-foreground shadow-sm hover:bg-primary-soft hover:border-primary/40 hover:text-primary",
        ...
        hero:
          "bg-highlight text-highlight-foreground shadow-md hover:brightness-105 hover:shadow-lg font-semibold",
        "outline-light":
          "border border-white/40 bg-white/0 text-white hover:bg-white/10 hover:border-white/70 backdrop-blur",
      },
      size: {
